	...
	protected void createButtonsForButtonBar(Composite parent) {
		...
		*/
		...
		okButton.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				System.out
						.println("ApexNavigatorSearchDialog.createButtonsForButtonBar(...).new SelectionListener() {...}.widgetSelected(), line : "
								+ Thread.currentThread().getStackTrace()[1]
										.getLineNumber());
				HierarchyInformationControl resultControl = new HierarchyInformationControl(shell, SWT.RESIZE|SWT.BORDER, SWT.NONE);
