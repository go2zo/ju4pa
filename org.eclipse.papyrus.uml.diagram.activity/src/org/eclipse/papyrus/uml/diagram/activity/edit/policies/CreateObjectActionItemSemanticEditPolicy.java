...
import org.eclipse.papyrus.uml.diagram.activity.edit.commands.OutputPinInCreateObjectActionAsResultCreateCommand;
...
public class CreateObjectActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if(UMLElementTypes.OutputPin_3087 == baseElementType) {
			if(isExtendedType) {
				return getExtendedTypeCreationCommand(req, (IExtendedHintedElementType)requestElementType);
			}
			return getGEFWrapper(new OutputPinInCreateObjectActionAsResultCreateCommand(req));
		}
		return super.getCreateCommand(req);
	}
