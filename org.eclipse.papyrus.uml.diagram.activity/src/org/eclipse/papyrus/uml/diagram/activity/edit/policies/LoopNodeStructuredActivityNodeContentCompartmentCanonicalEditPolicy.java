 ...
 * @generated
 */
public class LoopNodeStructuredActivityNodeContentCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getLoopNodeStructuredActivityNodeContentCompartment_7010SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getLoopNodeStructuredActivityNodeContentCompartment_7010SemanticChildren((View)getHost().getModel());
