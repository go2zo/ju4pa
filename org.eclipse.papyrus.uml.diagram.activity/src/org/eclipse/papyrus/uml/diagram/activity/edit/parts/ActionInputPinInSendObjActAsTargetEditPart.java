 ...
 * @generated
 */
public class ActionInputPinInSendObjActAsTargetEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public ActionInputPinInSendObjActAsTargetEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ActionInputPinInSendObjActAsTargetItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof ActionInputPinInSendObjActAsTargetLabelEditPart || borderItemEditPart instanceof ActionInputPinInSendObjActAsTargetValueEditPart || borderItemEditPart instanceof ActionInputPinInSendObjActAsTargetAppliedStereotypeEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ActionInputPinInSendObjActAsTargetLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.ActionInputPinInSendObjActAsTargetEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
