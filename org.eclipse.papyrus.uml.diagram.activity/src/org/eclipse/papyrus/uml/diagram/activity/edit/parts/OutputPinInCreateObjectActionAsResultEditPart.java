 ...
 * @generated
 */
public class OutputPinInCreateObjectActionAsResultEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public OutputPinInCreateObjectActionAsResultEditPart(View view) {
		super(view);
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof OutputPinInCreateObjectActionAsResultLabelEditPart || borderItemEditPart instanceof OutputPinInCreateObjectActionAsResultAppliedStereotypeWrappingLabelEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(OutputPinInCreateObjectActionAsResultLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.OutputPinInCreateObjectActionAsResultEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
