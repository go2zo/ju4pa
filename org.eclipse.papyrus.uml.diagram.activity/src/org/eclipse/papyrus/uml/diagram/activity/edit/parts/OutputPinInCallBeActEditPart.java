...
import org.eclipse.papyrus.uml.diagram.activity.edit.policies.OutputPinInCallBeActItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OutputPinInCallBeActEditPart extends BorderedBorderItemEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof OutputPinInCBActLabelEditPart || borderItemEditPart instanceof OutputPinInCBActAppliedStereotypeEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.OutputPinInCallBeActEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
