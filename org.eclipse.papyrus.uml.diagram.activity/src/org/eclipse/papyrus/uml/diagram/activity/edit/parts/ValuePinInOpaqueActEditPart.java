...
import org.eclipse.papyrus.uml.diagram.activity.edit.policies.ValuePinInOpaqueActItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ValuePinInOpaqueActEditPart extends BorderedBorderItemEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof ValuePinInOActLabelEditPart || borderItemEditPart instanceof ValuePinInOActValueEditPart || borderItemEditPart instanceof ValuePinInOActAppliedStereotypeEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.ValuePinInOpaqueActEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
