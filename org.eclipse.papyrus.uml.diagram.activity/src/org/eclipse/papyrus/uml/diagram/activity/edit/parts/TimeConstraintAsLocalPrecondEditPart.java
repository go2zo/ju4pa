...
import org.eclipse.papyrus.uml.diagram.activity.figures.LocalPreconditionConstraintFigure;
 ...
 * @generated
 */
public class TimeConstraintAsLocalPrecondEditPart extends AbstractConstraintEditPart {
	 ...
	 * @generated
	 */
	public TimeConstraintAsLocalPrecondEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TimeConstraintAsLocalPrecondItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof TimeConstraintAsLocalPrecondNameEditPart) {
			((TimeConstraintAsLocalPrecondNameEditPart)childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
