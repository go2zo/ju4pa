...
public class OutputPinInReadStructuralFeatureAsResultEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 3090;
	 ...
	 * @generated
	 */
	public OutputPinInReadStructuralFeatureAsResultEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OutputPinInReadStructuralFeatureAsResultItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof OutputPinInReadStructuralFeatureAsResultLabelEditPart || borderItemEditPart instanceof InputPinInReadStructuralFeatureAsResultWrappingLabelEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.OutputPinInReadStructuralFeatureAsResultEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
