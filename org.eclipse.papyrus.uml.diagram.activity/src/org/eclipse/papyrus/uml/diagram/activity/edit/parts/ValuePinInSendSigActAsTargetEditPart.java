...
import org.eclipse.papyrus.uml.diagram.activity.edit.policies.ValuePinInSendSigActAsTargetItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ValuePinInSendSigActAsTargetEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public ValuePinInSendSigActAsTargetEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ValuePinInSendSigActAsTargetItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof ValuePinInSendSigActAsTargetLabelEditPart || borderItemEditPart instanceof ValuePinInSendSigActAsTargetValueEditPart || borderItemEditPart instanceof ValuePinInSendSigActAsTargetAppliedStereotypeEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ValuePinInSendSigActAsTargetLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.ValuePinInSendSigActAsTargetEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
