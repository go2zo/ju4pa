...
import org.eclipse.papyrus.uml.diagram.activity.edit.commands.OutputPinInReadVariableActionAsResultCreateCommand;
 ...
 * @generated
 */
public class ReadVariableActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ReadVariableActionItemSemanticEditPolicy() {
		super(UMLElementTypes.ReadVariableAction_3097);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if(UMLElementTypes.OutputPin_3098 == baseElementType) {
			if(isExtendedType) {
				return getExtendedTypeCreationCommand(req, (IExtendedHintedElementType)requestElementType);
			}
			return getGEFWrapper(new OutputPinInReadVariableActionAsResultCreateCommand(req));
		}
		return super.getCreateCommand(req);
	}
