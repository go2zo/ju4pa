...
public class InputPinInDestroyObjectActionEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public InputPinInDestroyObjectActionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InputPinInDestroyObjectActionItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof InputPinInDestroyObjectActionLabelEditPart || borderItemEditPart instanceof InputPinInDestroyObjectActionAppliedStereotypeWrappingLabelEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.InputPinInDestroyObjectActionEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
