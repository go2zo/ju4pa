 ...
 * @generated
 */
public class ActionInputPinInSendObjActAsReqEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public ActionInputPinInSendObjActAsReqEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ActionInputPinInSendObjActAsReqItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof ActionInputPinInSendObjActAsReqLabelEditPart || borderItemEditPart instanceof ActionInputPinInSendObjActAsReqValueEditPart || borderItemEditPart instanceof ActionInputPinInSendObjActAsReqAppliedStereotypeEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ActionInputPinInSendObjActAsReqLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.ActionInputPinInSendObjActAsReqEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
