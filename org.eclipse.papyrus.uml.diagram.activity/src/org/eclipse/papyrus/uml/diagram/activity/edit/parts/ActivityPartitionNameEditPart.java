 ...
 * @generated
 */
public class ActivityPartitionNameEditPart extends PapyrusCompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ActivityPartition_3067, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ActivityPartitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
