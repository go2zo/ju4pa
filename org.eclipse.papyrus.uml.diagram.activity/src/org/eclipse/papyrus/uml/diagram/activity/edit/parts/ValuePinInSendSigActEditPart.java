...
import org.eclipse.papyrus.uml.diagram.activity.edit.policies.ValuePinInSendSigActItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ValuePinInSendSigActEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public ValuePinInSendSigActEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ValuePinInSendSigActItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof ValuePinInSendSigActLabelEditPart || borderItemEditPart instanceof ValuePinInSendSigActValueEditPart || borderItemEditPart instanceof ValuePinInSendSigActAppliedStereotypeEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ValuePinInSendSigActLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.ValuePinInSendSigActEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
