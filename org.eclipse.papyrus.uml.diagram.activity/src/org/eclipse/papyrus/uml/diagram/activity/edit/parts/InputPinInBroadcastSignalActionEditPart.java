 ...
 * @generated
 */
public class InputPinInBroadcastSignalActionEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public InputPinInBroadcastSignalActionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InputPinInBroadcastSignalActionItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof InputPinInBroadcastSignalActionLabelEditPart || borderItemEditPart instanceof InputPinInBroadcastSignalActionValueLabelEditPart || borderItemEditPart instanceof InputPinInBroadcastSignalActionAppliedStereotypeWrappingLabelEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.InputPinInBroadcastSignalActionEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
