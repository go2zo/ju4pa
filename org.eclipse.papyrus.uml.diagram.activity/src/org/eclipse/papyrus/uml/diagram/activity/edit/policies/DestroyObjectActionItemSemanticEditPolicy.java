...
import org.eclipse.papyrus.uml.diagram.activity.edit.commands.InputPinInDestroyObjectActionCreateCommand;
 ...
 * @generated
 */
public class DestroyObjectActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public DestroyObjectActionItemSemanticEditPolicy() {
		super(UMLElementTypes.DestroyObjectAction_3095);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if(UMLElementTypes.InputPin_3096 == baseElementType) {
			if(isExtendedType) {
				return getExtendedTypeCreationCommand(req, (IExtendedHintedElementType)requestElementType);
			}
			return getGEFWrapper(new InputPinInDestroyObjectActionCreateCommand(req));
		}
		return super.getCreateCommand(req);
	}
