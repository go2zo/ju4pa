 ...
 * @generated
 */
public class ActionInputPinInSendSigActAsTargetEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public ActionInputPinInSendSigActAsTargetEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ActionInputPinInSendSigActAsTargetItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof ActionInputPinInSendSigActAsTargetLabelEditPart || borderItemEditPart instanceof ActionInputPinInSendSigActAsTargetValueEditPart || borderItemEditPart instanceof ActionInputPinInSendSigActAsTargetAppliedStereotypeEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ActionInputPinInSendSigActAsTargetLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.ActionInputPinInSendSigActAsTargetEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
