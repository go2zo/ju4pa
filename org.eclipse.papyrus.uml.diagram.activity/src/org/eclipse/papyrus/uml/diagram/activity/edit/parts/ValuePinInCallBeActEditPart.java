...
import org.eclipse.papyrus.uml.diagram.activity.edit.policies.ValuePinInCallBeActItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ValuePinInCallBeActEditPart extends BorderedBorderItemEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof ValuePinInCBActLabelEditPart || borderItemEditPart instanceof ValuePinInCBActValueEditPart || borderItemEditPart instanceof ValuePinInCBActAppliedStereotypeEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.ValuePinInCallBeActEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
