 ...
 * @generated
 */
public class IntervalConstraintAsLocalPostcondEditPart extends AbstractConstraintEditPart {
	 ...
	 * @generated
	 */
	public IntervalConstraintAsLocalPostcondEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IntervalConstraintAsLocalPostcondItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof IntervalConstraintAsLocalPostcondNameEditPart) {
			((IntervalConstraintAsLocalPostcondNameEditPart)childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
		if(childEditPart instanceof IntervalConstraintAsLocalPostcondBodyEditPart) {
			((IntervalConstraintAsLocalPostcondBodyEditPart)childEditPart).setLabel(getPrimaryShape().getConstraintFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(IntervalConstraintAsLocalPostcondNameEditPart.VISUAL_ID));
	}
