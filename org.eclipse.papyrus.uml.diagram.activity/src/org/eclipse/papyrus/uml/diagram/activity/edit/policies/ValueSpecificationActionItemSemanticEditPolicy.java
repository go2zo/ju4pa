...
import org.eclipse.papyrus.uml.diagram.activity.edit.commands.OutputPinInValSpecActCreateCommand;
 ...
 * @generated
 */
public class ValueSpecificationActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if(UMLElementTypes.OutputPin_3077 == baseElementType) {
			if(isExtendedType) {
				return getExtendedTypeCreationCommand(req, (IExtendedHintedElementType)requestElementType);
			}
			return getGEFWrapper(new OutputPinInValSpecActCreateCommand(req));
		}
		return super.getCreateCommand(req);
	}
