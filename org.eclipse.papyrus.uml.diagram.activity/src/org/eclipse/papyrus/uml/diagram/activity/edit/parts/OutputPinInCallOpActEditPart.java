...
import org.eclipse.papyrus.uml.diagram.activity.edit.policies.OutputPinInCallOpActItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OutputPinInCallOpActEditPart extends BorderedBorderItemEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof OutputPinInCOActLabelEditPart || borderItemEditPart instanceof OutputPinInCOActAppliedStereotypeEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.OutputPinInCallOpActEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
