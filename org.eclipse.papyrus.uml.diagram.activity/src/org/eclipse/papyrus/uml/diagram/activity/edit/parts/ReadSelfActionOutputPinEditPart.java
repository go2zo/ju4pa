...
import org.eclipse.papyrus.uml.diagram.activity.edit.policies.ReadSelfActionOutputPinItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ReadSelfActionOutputPinEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public ReadSelfActionOutputPinEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ReadSelfActionOutputPinItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof OutputPinInReadSelfActionLabelEditPart || borderItemEditPart instanceof OutputPinInReadSelfActionAppliedStereotypeEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(OutputPinInReadSelfActionLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.ReadSelfActionOutputPinEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
