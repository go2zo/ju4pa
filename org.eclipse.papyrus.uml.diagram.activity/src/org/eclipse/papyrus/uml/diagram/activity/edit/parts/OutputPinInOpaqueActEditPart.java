 ...
 * @generated
 */
public class OutputPinInOpaqueActEditPart extends BorderedBorderItemEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof OutputPinInOActLabelEditPart || borderItemEditPart instanceof OutputPinInOActAppliedStereotypeEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.OutputPinInOpaqueActEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
