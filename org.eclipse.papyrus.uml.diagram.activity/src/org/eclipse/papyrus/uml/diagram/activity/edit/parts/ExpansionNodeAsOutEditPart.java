 ...
 * @generated
 */
public class ExpansionNodeAsOutEditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public ExpansionNodeAsOutEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ExpansionNodeAsOutItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.activity.edit.parts.ExpansionNodeAsOutEditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
