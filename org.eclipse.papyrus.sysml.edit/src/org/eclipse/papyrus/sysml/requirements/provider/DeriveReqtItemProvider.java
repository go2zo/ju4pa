...

{
	 ...
	 * @generated
	 */
	private static Pattern DERIVE_REQT_PREFIX_PATTERN = Pattern.compile("(deriveReqt, |<<deriveReqt>>|, deriveReqt)");
	...
	public Object getImage(Object object) {
		Object composedImage = overlayImage(object, getResourceLocator().getImage("full/obj16/DeriveReqt"));
	...
	public String getText(Object object) {
		...
		if(object instanceof org.eclipse.uml2.uml.Abstraction) {
			...
			if(ste != null) {
				...
				result = DERIVE_REQT_PREFIX_PATTERN.matcher(result).replaceFirst("");
				return ABSTRACTION_PREFIX_PATTERN.matcher(result).replaceFirst("DeriveReqt");
			}
