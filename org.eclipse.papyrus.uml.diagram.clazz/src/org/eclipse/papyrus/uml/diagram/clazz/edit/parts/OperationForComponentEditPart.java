 ...
 * @generated
 */
public class OperationForComponentEditPart extends UMLCompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart {
	 ...
	 * @generated
	 */
	public OperationForComponentEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Operation_3003, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.clazz.edit.parts.OperationForComponentEditPart.VISUAL_ID));
		}
		return parser;
	}
