...
import org.eclipse.papyrus.uml.diagram.clazz.edit.policies.NestedInterfaceForInterfaceItemSemanticEditPolicy;
...
public class NestedInterfaceForInterfaceEditPart extends CompartmentEditPart implements ITextAwareEditPart, IPrimaryEditPart {
	 ...
	 * @generated
	 */
	public NestedInterfaceForInterfaceEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new NestedInterfaceForInterfaceItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Interface_3038, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.clazz.edit.parts.NestedInterfaceForInterfaceEditPart.VISUAL_ID));
		}
		return parser;
	}
