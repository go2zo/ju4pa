 ...
 * @generated
 */
public class InterfaceRealizationName2EditPart extends PapyrusLabelEditPart implements ITextAwareEditPart, ILabelRoleProvider {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.clazz.edit.parts.InterfaceRealizationName2EditPart.VISUAL_ID), new Point(0, 60));
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InterfaceRealization_4003, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.clazz.edit.parts.InterfaceRealizationName2EditPart.VISUAL_ID));
		}
		return parser;
	}
